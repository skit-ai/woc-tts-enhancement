...
def spectral_subtraction(noise_profile_n, input_signal_y, dimension):
  '''
  This is the function which implements spectral subtraction, which removes a noise profile from a given input signal. This is done by first applying STFT on both the
