...
if __name__ == "__main__":
    ...
    waveform, sample_rate = torchaudio.load("docs/audio/kalman_filtered_sp15_station_sn5.wav")
    plot_waveform(waveform, sample_rate, "docs/images/Filters/kalman_filtered_audio_waveform.png")
    plot_specgram(waveform, sample_rate, "docs/images/Filters/wiener_filtered_spectrogram.png")